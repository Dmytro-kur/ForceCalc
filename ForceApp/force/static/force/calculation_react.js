...
'<div class="ck ck-content ck-editor__editable ck-rounded-corners ck-editor__editable_inline ck-blurred" lang="en" dir="ltr" role="textbox" aria-label="Rich Text Editor, main" contenteditable="true"><p>There is a mechanical scheme that consist of two rigid joins one allowable direction is X, beam from A point to C point and spring that generate a load linearly to damping distance.</p><p>There is a simplified model of regular switches inside the car.</p><p>Our task is to find a normal reaction in the point C (at the end of the button) therefore we can analyze how robust and reliable our final product will be.</p><p>One more task is to find a solution that satisfies peoples requirement that based on tactile feeling when we push or pull our switch.&nbsp;</p><p>Last task can be resolved by designing a mechanism with special parts. And Each part would play it own role for making this product good for end user.</p><p>In general while we push or pull our switch we can feel some snap its mean that we are on the force peak.&nbsp;</p><p>Instrument to solve this mechanical task is called beam on the two support with external load.</p><p>By using this system our beam constantly pushed by spring from left side and rigid surface from the right side.</p><p>Arrows shows us applied forces in each points direction of forces is where from this force were applied (in term of forces is expected like a physical constraint for example a wall or spring load).</p><p>This beam doesn\'t move anywhere while we change it position by hand it means that during all the time beam in a static balance. Based on this we would found all unknown vectors of forces.</p><p>We don\'t know only three forces Normal reaction in joint C, Reaction in the joint A and reaction in the joint B</p><p><br data-cke-filler="true"></p><p>On the sidebar is presented a set of parameters:&nbsp;</p><p>Contact: describes behavior in the contact. For example: physics point of view <a href="https://en.wikipedia.org/wiki/Friction">dry friction</a> with coefficient of friction from 0 to 1.</p><figure class="image ck-widget ck-widget_with-resizer image-style-block-align-right image_resized" contenteditable="false" style="width:25%;"><img src="/static/force/electric-handbrake.jpg"><figcaption class="ck-editor__editable ck-editor__nested-editable ck-placeholder" data-placeholder="Enter image caption" contenteditable="true"><br data-cke-filler="true"></figcaption><div class="ck ck-reset_all ck-widget__type-around"><div class="ck ck-widget__type-around__button ck-widget__type-around__button_before" title="Insert paragraph before block"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 8"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"></path></svg></div><div class="ck ck-widget__type-around__button ck-widget__type-around__button_after" title="Insert paragraph after block"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 8"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"></path></svg></div><div class="ck ck-widget__type-around__fake-caret"></div></div><div class="ck ck-reset_all ck-widget__resizer" style="height: 286px; left: 0px; top: 0px; width: 387px; display: none;"><div class="ck-widget__resizer__handle ck-widget__resizer__handle-top-left"></div><div class="ck-widget__resizer__handle ck-widget__resizer__handle-top-right"></div><div class="ck-widget__resizer__handle ck-widget__resizer__handle-bottom-right"></div><div class="ck-widget__resizer__handle ck-widget__resizer__handle-bottom-left"></div><div class="ck ck-size-view ck-orientation-bottom-right" style="display: none;">38.89%</div></div></figure><p><br data-cke-filler="true"></p><pre data-language="Plain text" spellcheck="false"><code class="language-plaintext">gferwfewf</code></pre></div>'

# Generated by Django 3.1.6 on 2021-06-17 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('b', models.FloatField()),
                ('f', models.FloatField()),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plungers', to='force.project')),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='force.project')),
            ],
        ),
        migrations.CreateModel(
            name='Angles',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='angles', to='force.project')),
            ],
        ),
    ]
